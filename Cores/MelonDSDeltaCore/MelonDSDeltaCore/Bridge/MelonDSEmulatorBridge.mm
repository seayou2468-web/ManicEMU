...
@property (nonatomic, readonly) MANCRingingBuffer *microphoneBuffer;
...
namespace Platform
{
    ...
    void StopEmu()
    {
        ...
        [[NSNotificationCenter defaultCenter] postNotificationName:MEEmulatorCore.emulationDidQuitNotification object:MelonDSEmulatorBridge.sharedBridge];
    }
