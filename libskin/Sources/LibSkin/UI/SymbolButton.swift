...
class SymbolButton: UIView {
    ...
    convenience init(symbol: SFSymbol,
                     title: String,
                     titleFont: UIFont = UIFont.systemFont.caption(),
                     ...
                     imageAndTitlePadding: CGFloat = CGSize.zero.ContentSpaceUltraTiny,
    ...
    private func setupTraditionalView(image: UIImage?,
        ...
        layerCornerRadius = CGSize.zero.CornerRadiusMid
    ...
    convenience init(symbol: SFSymbol, symbolFont: UIFont? = nil, symbolColor: UIColor = UIColor.label, enableGlass: Bool = false, cornerStyle: UIButton.Configuration.CornerStyle = .capsule) {
