...
class AuxiliaryLineView: UIView {
    ...
    let topHandle: UIView = {
        ...
        icon.image = UIImage(symbol: .chevronCompactUp, font: UIFont.systemFont.body(size: .s, weight: .medium), color: UIColor.label.forceStyle(.dark))
    ...
    let bottomHandle: UIView = {
        ...
        let icon = IconView()
        icon.imageView.contentMode = .scaleAspectFill
        icon.image = UIImage(symbol: .chevronCompactDown, font: UIFont.systemFont.body(size: .s, weight: .medium), color: UIColor.label.forceStyle(.dark))
        view.addSubview(icon)
        icon.snp.makeConstraints { make in
            make.center.equalToSuperview()
            make.size.equalTo(CGSize(width: 40, height: 20))
    ...
    let leftHandle: UIView = {
        ...
        let icon = IconView()
        icon.imageView.contentMode = .scaleAspectFill
        icon.image = UIImage(symbol: .chevronCompactLeft, font: UIFont.systemFont.body(size: .s, weight: .medium), color: UIColor.label.forceStyle(.dark))
        view.addSubview(icon)
        icon.snp.makeConstraints { make in
            make.center.equalToSuperview()
    ...
    let rightHandle: UIView = {
        ...
        let icon = IconView()
        icon.imageView.contentMode = .scaleAspectFill
        icon.image = UIImage(symbol: .chevronCompactRight, font: UIFont.systemFont.body(size: .s, weight: .medium), color: UIColor.label.forceStyle(.dark))
        view.addSubview(icon)
        icon.snp.makeConstraints { make in
            make.center.equalToSuperview()
            make.size.equalTo(CGSize(width: 20, height: 40))
