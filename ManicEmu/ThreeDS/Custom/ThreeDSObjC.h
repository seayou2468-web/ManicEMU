...
//  Citra
//
//  Created by Daiuno on 12/7/2024.
//
...
@interface ThreeDSGameInformation : NSObject
...
@interface ThreeDSObjC : NSObject {
#ifdef __cplusplus
...
+(ThreeDSObjC *) sharedInstance NS_SWIFT_NAME(shared());

-(ThreeDSGameInformation *) informationForGameAt:(NSURL *)url NS_SWIFT_NAME(informationForGame(at:));
