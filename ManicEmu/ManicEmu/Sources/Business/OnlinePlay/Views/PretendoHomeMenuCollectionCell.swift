//
//  PretendoHomeMenuCollectionCell.swift
//  ManicEmu
//
...
class PretendoHomeMenuCollectionCell: UICollectionViewCell {
    
    private lazy var descLabel: UILabel = {
        let label = UILabel()
        label.numberOfLines = 0
        let text = R.string.localizable.homeMenuDesc()
    ...
    private lazy var button: SymbolButton = {
        let view = SymbolButton(image: nil,
                                title: R.string.localizable.openHomeMenu(),
